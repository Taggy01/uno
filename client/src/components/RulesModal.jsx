          ...
          >
            ...
            <div className="flex items-center gap-3 mb-4 pb-3 border-b border-neutral-800">
              ...
              <div>
                ...
                <Typography className="text-xs text-neutral-400">
                  Rules, special cards & scoring guide
                </Typography>
              </div>
            </div>

            <div className="flex-1 overflow-y-auto space-y-4 text-xs text-neutral-300 pr-1 scrollbar-thin">
              <Card className="bg-neutral-800/60 p-3.5 rounded-2xl border border-neutral-700/60">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  <Card className="p-3 bg-neutral-800/40 rounded-xl border border-neutral-800">
              ...
              <Card className="bg-amber-500/10 p-3.5 rounded-2xl border border-amber-500/20 text-amber-200">
            ...
            <div className="pt-3 mt-2 border-t border-neutral-800">
              <Button
                ...
                variant="primary"
                onClick={onClose}
                className="w-full py-3 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl text-xs transition-colors cursor-pointer h-auto"
              >
                Got It!
              </Button>
            </div>
